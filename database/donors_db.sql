...
CREATE TABLE Donations (
    ...
    FOREIGN KEY (charity_id) REFERENCES Charities (charity_id) ON DELETE SET NULL
);
...
INSERT INTO Projects (name, amount_needed, amount_raised) VALUES 
("Protecting Wildlife", "10000", '0'), 
("Providing Hurricane Relief", "10000", '0'), 
("Building Exersice Facilities", "10000", '0'),
("Humanitarian assisstance", "10000", '0');
